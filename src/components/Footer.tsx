                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-white/60">
                            ...
                            <li><a href="#" className="hover:text-white transition-colors">Residential Services</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Commercial Foundations</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Interactive Planning Studio</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">About Our Craft</a></li>
                        </ul>
                    </div>
